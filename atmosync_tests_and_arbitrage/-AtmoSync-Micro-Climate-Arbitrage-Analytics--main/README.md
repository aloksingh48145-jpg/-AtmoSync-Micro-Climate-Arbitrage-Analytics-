...
superset/       Superset dashboard configs/exports (production-grade BI)
dashboard/      Streamlit live dashboard (fast, always-demoable, live/sample fallback)
...
- [x] Kafka producer: simulated IoT sensor + spoilage event data
- [x] Snowflake raw ingestion (consumer)
- [x] dbt staging + marts models
- [x] Superset dashboards (see `superset/SETUP.md`)
- [x] Streamlit live dashboard with Arbitrage View + explainable recommendations (see `dashboard/README.md`)
- [x] Test suite, 27 tests passing (see `tests/README.md`)
